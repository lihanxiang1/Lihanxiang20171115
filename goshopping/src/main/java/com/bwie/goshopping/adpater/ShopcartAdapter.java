package com.bwie.goshopping.adpater;
...
import com.bwie.goshopping.bean.GoodsInfo;
import com.bwie.goshopping.bean.StoreInfo;

import java.util.List;
import java.util.Map;

/**
 * Created by Lonely on 2017/11/15.
 */
public class ShopcartAdapter extends BaseExpandableListAdapter {
     ...
     * @param context
     */
    public ShopcartAdapter(List<StoreInfo> groups, Map<String, List<GoodsInfo>> children, FragmentActivity context) {
        this.groups = groups;
